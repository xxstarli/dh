...
?><!doctype html>
<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title><?= h($data['settings']['site_name']) ?></title><link rel="icon" href="/assets/brand.svg" type="image/svg+xml"><link rel="stylesheet" href="/assets/app.css"><link rel="stylesheet" href="/assets/theme/doraemon/theme.css"><script defer src="/assets/sortable.min.js"></script><script type="module" src="/assets/app.js"></script></head>
<body>
<div class="theme-scenery" aria-hidden="true">
<img class="theme-clouds-top" src="/assets/theme/doraemon/云朵_顶部.png" alt="" width="2172" height="724">
<img class="theme-clouds-bottom" src="/assets/theme/doraemon/云朵_底部.png" alt="" width="2172" height="724">
<img class="theme-copter" src="/assets/theme/doraemon/竹蜻蜓.png" alt="" width="1774" height="887">
<img class="theme-door" src="/assets/theme/doraemon/任意门.png" alt="" width="1024" height="1536">
<img class="theme-bell" src="/assets/theme/doraemon/铃铛.png" alt="" width="1254" height="1254">
</div>
<header class="topbar"><div class="topbar-inner"><img class="header-character" src="/assets/theme/doraemon/哆啦A梦_顶部人物.png" alt="" aria-hidden="true" width="1122" height="1402"><div class="brand"><?= $data['settings']['site_logo'] ? site_icon($data['settings']['site_logo'], '站点') : '<span class="brand-icon"><img src="/assets/theme/doraemon/哆啦A梦_Logo.png" alt="" width="55" height="55"></span>' ?><div><h1><?= h($data['settings']['site_name']) ?></h1><p>高效上网，从这里开始</p></div></div><div class="search-box"><?= svg('Search') ?><input aria-label="搜索网站" placeholder="搜索网站..." id="search"><button class="icon-button" aria-label="清除搜索" data-action="clear-search" hidden><?= svg('X', 17) ?></button></div><button class="button primary manage-button" disabled><?= svg('Settings', 18) ?><span>管理</span></button></div></header>
